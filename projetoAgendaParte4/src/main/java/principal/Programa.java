		...
		while (opcao != 5) {
			...
			if (opcao == 1) {
				...
				if (nome == null) {
					...
					if (VerificaEmail.verificaEmail(email)) {
						...
						System.out
								.println("Iremos retornar ao menu principal para você� realizar o cadastro novamente");
					}
				}
			}
			...
			if (opcao == 2) {
				...
				if (nomeBusca != null) {
					...
					System.out.println("Voc� esqueceu de digitar o nome");
				}
			...
			if (opcao == 4) {
				...
				agenda01.removerContato(nomeBusca);
			}
